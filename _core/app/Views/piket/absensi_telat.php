...
<div class="app-card app-card-accordion shadow-sm mb-4">
    <div class="app-card-body p-4">
        ...
        <form action="<?= base_url('piket/absensi_telat/save') ?>" method="POST">
            <div class="row">
                <div class="col-md-3">
        ...
        <div class="alert alert-info mt-4">CATATAN: Absensi terlambat Akan menambahkan <b>1 POIN Pelanggaran</b>.</div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
        $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?= base_url('piket/absensi_telat/data') ?>',
            order: [],
            columns: [{
                    data: 'no',
                    orderable: false
