...
<div class="app-card app-card-accordion shadow-sm mb-4">
    <div class="app-card-body p-4">
        ...
        <form action="<?= base_url('bp/poin/save') ?>" method="POST">
            <div class="row">
                <div class="col-md-2">
                    <strong>Tambah Poin:</strong>
                </div>
                <div class="col-md-4">
                    <input type="text" name="pelanggaran" class="form-control" placeholder="Nama Pelanggaran">
                </div>
                <div class="col-md-3">
