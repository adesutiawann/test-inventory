...
<div class="app-card app-card-accordion shadow-sm mb-4">
    <div class="app-card-body p-4">
        <form action="<?= base_url('admin/laporan_semester') ?>" method="GET">
            <div class="row">
                <div class="col-md-2">
...
<?php if (isset($_GET['tahun_pelajaran'])) : ?>
    <div class="app-card app-card-accordion shadow-sm mb-4">
        <div class="app-card-body p-4">
                ...
                <table class="table table-sm table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($kls as $kelas) : ?>
                            ...
                            <?php $count_h = $absensi->where(['kelas' => $kelas->kelas, 'absensi' => 'h', 'tahun_pelajaran' => $_GET['tahun_pelajaran'], 'semester' => $_GET['semester']])->countAllResults() ?>
                            <?php $count_s = $absensi->where(['kelas' => $kelas->kelas, 'absensi' => 's', 'tahun_pelajaran' => $_GET['tahun_pelajaran'], 'semester' => $_GET['semester']])->countAllResults() ?>
                            <?php $count_i = $absensi->where(['kelas' => $kelas->kelas, 'absensi' => 'i', 'tahun_pelajaran' => $_GET['tahun_pelajaran'], 'semester' => $_GET['semester']])->countAllResults() ?>
                            <?php $count_a = $absensi->where(['kelas' => $kelas->kelas, 'absensi' => 'a', 'tahun_pelajaran' => $_GET['tahun_pelajaran'], 'semester' => $_GET['semester']])->countAllResults() ?>
                            <?php $total = $count_a + $count_h + $count_s + $count_i ?>
                            <?php if ($total != 0) : ?>
                                <?php $persen_kehadiran = floor(($count_h / $total) * 100) ?>
                            <?php else : ?>
                                <?php $persen_kehadiran = 0; ?>
                            <?php endif ?>
                            <tr>
