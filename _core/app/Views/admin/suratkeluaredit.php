                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="p-3 border bg-light">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-2">
                                        Jumlah :
                                        <input type="text" name="jumlah" class="form-control" required placeholder="000" value=" <?= $suratkeluar->jumlah ?>">

                                    </div>
                                    <div class="col-5">
                                        Satuan :
                                        <input type="text" name="satuan" class="form-control" required placeholder="Unit" value=" <?= $suratkeluar->satuan ?>">
                                    ...
                                    <div class="col-5 mb-4">
                                        ...
                                        <select name="status" id="status" class="form-select">
                                            <?php foreach ($stock as $item) : ?>
                                                <?php $selected = ($item->nama === $suratkeluar->status) ? 'selected' : ''; ?>
                                    ...
                                    <div class="col-md-12 mb-5">
                                        ...
                                        <div class="form-floating">
                                            <textarea name="ket" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"> <?= $suratkeluar->ket ?></textarea>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="p-3 border bg-light">
                                ...
                                <div class="row ">
                                    <div class="col-2">
                                        NIK :
                                        <input type="text" name="nik" class="form-control UPPERCASE" required placeholder="NIK" value="<?= $suratkeluar->nik ?>">

                                    </div>
                                    <div class="col-5">
                                        Penerima :
                                        <input type="text" name="penerima" class="form-control" required placeholder="Nama Penerima" value="<?= $suratkeluar->penerima ?>">

                                    </div>
                                    <div class="col-5">
                                        Telpon :
                                        <input type="text" name="telpon" class="form-control" required placeholder="Telpon " value="<?= $suratkeluar->telpon ?>">

                                    </div>
                                    <div class="col-md-12 mb-5 mt-3">
                                        Lokasi
                                        <div class="form-floating">
                                            <textarea name="lokasi" class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px"><?= $suratkeluar->lokasi ?></textarea>
