...
<div class="app-card app-card-accordion shadow-sm mb-4">
    <div class="app-card-body p-4">
        ...
        <?php if(isset($rincian->id)){
            ?>
        <form action="<?= base_url('admin/rincian/saveedit') ?>" method="POST">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-4">
                        ...
                        <input type="" hidden name="id" value="<?=$rincian->id ?>">
                         <input type="text" value="<?=$rincian->nama?>" name="nama" class="form-control" autofocus  required>
...
<script>
    $(document).ready(function() {
        $('#table').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?= base_url('admin/rincian/data') ?>',
            order: [],
            columns: [{
                    data: 'no',
                    orderable: false
