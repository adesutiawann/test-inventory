    ...
    <div class="app-card-body p-3">
        ...
        <div class="row-md-12 row-sm-12 row-xs-12">
            ...
            <div class="col  ">
                <div class="row ">
                    <div class="col  ">
                        <a href="<?= base_url('admin/mouse/add') ?>" class="btn app-btn-primary text-white ml-5 ">
                    ...
                    <div class="col text-end">
                        ...
                        <a href="<?= base_url("admin/mouse/deleteall/mouse") ?>" class="btn btn-sm btn-danger text-white hapusDataBtn" data-id="Semua mouse">
...
<nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm d-flex mb-1" role="tablist">
    <a class="flex-fill text-center nav-link <?= ($menu == 'ALL') ? 'active' : '' ?>" href="<?= base_url('admin/mouse/') ?>" aria-controls="orders-all" aria-selected="false">All <?= $total_mo ?></a>
    <a class="flex-fill text-center nav-link <?= ($menu == 'OK') ? 'active' : '' ?>" href="<?= base_url('admin/mouse/search/OK') ?>" aria-controls="orders-paid" aria-selected="false">Oke <?= $total_mo_ok ?></a>
    <a class="flex-fill text-center nav-link <?= ($menu == 'RUSAK') ? 'active' : '' ?>" href="<?= base_url('admin/mouse/search/RUSAK') ?>" role="tab" aria-controls="orders-pending" aria-selected="true">Rusak <?= $total_mo_rusak ?></a>
    <a class="flex-fill text-center nav-link <?= ($menu == 'BLANK') ? 'active' : '' ?>" href="<?= base_url('admin/mouse/search/BLANK') ?>" role="tab" aria-controls="orders-cancelled" aria-selected="true">Blank <?= $total_mo_blanks ?></a>
</nav>
                    ...
                    ?>
                        <tr class="table-<?= ($value->kondisi == 'OK') ? 'success ' : (($value->kondisi == 'RUSAK') ? 'warning' : 'danger') ?>">
                            ...
                            <td>
                                ...
                                <a href="<?= base_url('admin/mouse/view/' . $value->serial) ?>" <?= ($admin->level == '3') ? 'hidden' : '' ?> class="btn btn-sm btn-primary text-white mr-2">
                                    <i class="fa-solid fa-circle-info"></i>
                                </a>

                                <a href="<?= base_url('admin/mouse/edit/' . $value->serial) ?>" class="btn btn-sm btn-info text-white ">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>

                                <a href="<?= base_url("admin/mouse/delete/{$value->id}") ?>" class="btn btn-sm btn-danger text-white hapusDataBtn" data-id="<?php echo $value->serial; ?>">
                                    <i class="fa-solid fa-trash-can"></i>
                                </a>
            ...
            <script>
                ...
                function generateQR(text, imgBox, qrImage) {
                    if (text.length > 0) {
                        ...
                        let qrCodeUrl = "https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=<?= base_url() ?>/admin/mouse/view/" + text;
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="row" action="<?= base_url('admin/mouse/import') ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-1 col-sm-3 text-end mb-2 ">
                        <a href="<?= base_url('admin/mouse/downloadExcel') ?>" class="text-info">
...
<div class="modal fade" id="qrcode" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content mt-15">
            ...
            <div class="modal-body">
                <form class="row" action="<?= base_url('admin/mouse/cetakqrcode') ?>" target="_blank" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="pdf" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content mt-15">
            ...
            <div class="modal-body">
                <form class="row" action="<?= base_url('admin/mouse/cetakpdf') ?>" target="_blank" method="post" enctype="multipart/form-data">
...
<div class="modal fade" id="excel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content mt-15">
            ...
            <div class="modal-body">
                <form class="row" action="<?= base_url('admin/mouse/export') ?>" method="post" enctype="multipart/form-data">
