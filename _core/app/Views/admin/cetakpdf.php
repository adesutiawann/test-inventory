        ...
        <div class="app-card-body p-3">
            ...
            <div class="row ">
                ...
                <div class="col-12 ml-4 text-center mb-3 mt-3">
                    <h3 class="mt-3">Data Personal Computer</h3>
                </div>
                ...
                <div class="col-12 ml-4  MT-3">
                    ...
                    <table id="tabel" class="table responsive-table">
                        <thead>
                            <tr>
                                <th>NO.</th>
                                <th>QRCode</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="table-<?= ($value->kondisi == 'OK') ? 'success ' : (($value->kondisi == 'RUSAK') ? 'warning' : 'danger') ?>">
                                    ...
                                    <td>
                                        Prosesor,<?= $value->prosesor ?>
                                        Generasi,<?= $value->generasi ?>
                                        <?= $value->hdd ?>
                                        Ram :<?= $value->ram ?>/<?= $value->rincian ?>
                                    </td>
                                    <td>
                                        <?= $value->status ?>,<?= $value->stock ?>
