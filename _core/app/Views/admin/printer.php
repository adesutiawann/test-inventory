...
<nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm d-flex mb-1" role="tablist">
    <a class="flex-fill text-center nav-link <?= ($menu == 'ALL') ? 'active' : '' ?>" href="<?= base_url('admin/mouse/') ?>" aria-controls="orders-all" aria-selected="false">All <?= $total_pr ?></a>
    <a class="flex-fill text-center nav-link <?= ($menu == 'OK') ? 'active' : '' ?>" href="<?= base_url('admin/mouse/search/OK') ?>" aria-controls="orders-paid" aria-selected="false">Oke <?= $total_pr_ok ?></a>
    <a class="flex-fill text-center nav-link <?= ($menu == 'RUSAK') ? 'active' : '' ?>" href="<?= base_url('admin/mouse/search/RUSAK') ?>" role="tab" aria-controls="orders-pending" aria-selected="true">Rusak <?= $total_pr_rusak ?></a>
    <a class="flex-fill text-center nav-link <?= ($menu == 'BLANK') ? 'active' : '' ?>" href="<?= base_url('admin/mouse/search/BLANK') ?>" role="tab" aria-controls="orders-cancelled" aria-selected="true">Blank <?= $total_pr_blanks ?></a>
</nav>
