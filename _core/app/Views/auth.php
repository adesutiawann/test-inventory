...
<head>
	...
	<meta name="description" content="Aplikasi Inventory Krakatau Information Technologi">
			...
			<div class="d-flex flex-column align-content-end mt-5">
				<div class="app-auth-body mx-auto  mt-5">
					...
					<div class="auth-form-container text-start">
						...
						<form class="auth-form login-form" method="POST" action="<?= base_url('auth/proses') ?>">
							...
							<div class="text-center">
								<button type="submit" class="btn app-btn-biru w-100 theme-btn mx-auto">MASUK</button>
							</div>
						</form>
			...
			<div class="auth-background-overlay p-3 p-lg-5">
				<div class="d-flex flex-column align-content-end h-100">
					...
					<div class="overlay-content p-3 p-lg-4 rounded">
						<h5 class="mb-3 overlay-title">Aplikasi PC Inventory Master</h5>
						<div>Aplikasi ini bertujuan untuk memudahkan pelaporan barang masuk dan keluar yang di lakukan oleh prusahaan.</div>
					</div>
				</div>
			</div>
