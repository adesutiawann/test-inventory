...
class Keyboard extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'total_mo_ok' => $this->aset->where('type', 'keyboard')->where('kondisi', 'OK')->countAllResults(),
            'total_mo_rusak' => $this->aset->where('type', 'keyboard')->where('kondisi', 'rusak')->countAllResults(),
            'total_mo_blanks' => $this->aset->where('type', 'keyboard')->where('kondisi', 'blanks')->countAllResults(),
        ];
